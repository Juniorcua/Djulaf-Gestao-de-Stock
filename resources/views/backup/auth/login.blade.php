     ...
     <ul class="navbar-nav ml-auto">
        ...
        <div class="card ">
            ...
            <div class="card-body" align="center">
                <h6 class="mb-3 mt-2"> Caro utilizador, ja esta com uma sessão inciada!!</h6>

                <a class="btn btn-outline-danger btn-light" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">


                    <i class="fa fa-power-off"></i> Encerar sessão </a>
